...
def main(args):
    ...
    ax1.scatter(points0[:, 0], points0[:, 1], points0[:, 2])
    ax1.scatter(points1[:, 0], points1[:, 1], points1[:, 2])
    ax2.scatter(points0[:, 0], points0[:, 1], points0[:, 2])
    ax2.scatter(points2[:, 0], points2[:, 1], points2[:, 2])
    ax3.scatter(points0[:, 0], points0[:, 1], points0[:, 2])
    ax3.scatter(points3[:, 0], points3[:, 1], points3[:, 2])
